...
life_table_derivatives_R = "src//life_table_derivatives.R"


def run_r(path: str, *args: str):
    cmd = ["Rscript", path, *map(str, args)]
    log.log(f"running R: {''.join(cmd)}")
...
if __name__ == "__main__":
    ...
    run_r(life_table_derivatives_R, life_table_path, life_table_path) # add things like dx, sx, qx etc...
